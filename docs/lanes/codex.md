...
Current slice: src/peb/web, tests/web, tests/browser, docs/WORKROOM.md. Real
...
No frozen contracts or bind_grants changed. Next: review cockpit at its named
commit, merge reviewed main, then release checker and matrix.
